...
$(document).ready(function() {
  window.prolongation_ENT_args = { current: 'phototheque',is_logged: true, extra_css:'https://phototheque-test.univ-paris1.fr/local/css/bandeau.css', logout: 'a[href="?act=logout"]'}
  var myscript = document.createElement('script');
  myscript.setAttribute('src','https://ent-test.univ-paris1.fr/ProlongationENT/loader.js');
